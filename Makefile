...
salt-blackout:: clean
	git archive --format=tar.gz --prefix=salt-blackout-formula-${SALT_BLACKOUT_VERSION}/ HEAD:salt-blackout-formula/ >salt-blackout-formula-${SALT_BLACKOUT_VERSION}.tar.gz
